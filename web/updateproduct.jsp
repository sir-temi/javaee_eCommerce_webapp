        ...
        <div class="row">
            ...
            <div class="col-sm-8" id="rightdash">
                <div class="row">
                        ...
                        <div>
                            <center>
                                <h4 class="head">Update cake information</h4>
                            <form action="DelEditProductServlet" method="POST" class="row g-3">
                                ...
                                <div class="form-floating col-md-6">
                                    <input type="text" name="quantity" value="${quantity}" onkeypress="return (event.charCode !== 8 && event.charCode === 0 || ( event.charCode === 46 || (event.charCode >= 48 && event.charCode <= 57)))" maxlength="7" class="form-control pl" id="floatingInput" aria-describedby="emailHelp" placeholder="Quantity" required>
                                    <label for="floatingInput" id="h">Total quantity in stock</label>
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" name="product_description" value="${product_description}" placeholder="Product description" id="floatingTextarea" style="height: 100px" required>${product_description}</textarea>
                                    <label for="floatingTextarea" id="h">Product description</label>
                                </div>
                                <div class="form-floating d-grid gap-2">
                                    <!--<div class="d-grid gap-2">-->
                                        <button type="submit" class="btn btn-primary btn-lg"><i class="far fa-plus-square fa-1x"></i> UPDATE</button>
                                        <input name="action" value="UPDATE_PRODUCT" type="hidden">
